package com.ysx.architect.test.rabbitmq.difficult.consumer;
...
import com.ysx.architect.test.rabbitmq.difficult.util.RabbitMqUtil;
...
public class UserRabbitMqConsumer {
    ...
    private final static Logger LOG = LoggerFactory.getLogger(UserRabbitMqConsumer.class);
