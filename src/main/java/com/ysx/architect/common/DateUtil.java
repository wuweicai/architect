...
import com.ysx.architect.test.thread.Common.LogManager;
...
public class DateUtil {
    private static final LogManager logger = LogManager.getLogger(DateUtil.class);
    ...
    public static String nextDayDate(String loopDate, int addOsubNum) {
        ...
        calendar.setTime(str2Date(loopDate, (String)null));
        calendar.add(6, addOsubNum);
        return date2Str(calendar.getTime(), (String)null);
    }
    ...
    public static Date converDate(String inValue) throws Exception {
        if (inValue == null) {
            ...
            if (value.indexOf("年") > 0 && value.indexOf("月") > 0 && value.indexOf("日") > 0 && value.indexOf("时") > 0 && value.indexOf("分") > 0 && value.indexOf("秒") > 0 && value.indexOf("毫秒") > 0) {
            ...
            } else if (value.indexOf("年") > 0 && value.indexOf("月") > 0 && value.indexOf("日") > 0 && value.indexOf("时") > 0 && value.indexOf("分") > 0 && value.indexOf("秒") > 0) {
                return str2Date(value, "yyyy年MM月dd日 HH时mm分ss秒");
            } else if (value.indexOf("/") > 0 && value.trim().length() == 10) {
                return str2Date(value, "yyyy/MM/dd");
            } else if (value.indexOf("-") > 0 && value.trim().length() == 19) {
                return str2Date(value, "yyyy-MM-dd HH:mm:ss");
            } else if (value.indexOf("-") > 0 && value.trim().length() == 23) {
                return str2Date(value, "yyyy-MM-dd HH:mm:ss.SSS");
            } else if (value.indexOf("-") > 0 && value.trim().length() == 10) {
                return str2Date(value, "yyyy-MM-dd");
            } else if (value.indexOf(":") > 0 && value.trim().length() == 8) {
                return str2Date(value, "HH:mm:ss");
            } else if (value.indexOf(":") > 0 && value.trim().length() == 12) {
            ...
            } else if (value.indexOf(" ") > 0 && value.trim().length() == 15) {
                return str2Date(value, "yyyyMMdd HHmmss");
            } else if (value.indexOf(" ") > 0 && value.trim().length() == 18) {
                ...
                return value.trim().length() == 9 ? str2Date(value, "HHmmssSSS") : null;
            }
        }
    }
    ...
    public static long compareTime(String sStartdates, String bEnddates, String dateFormat) throws ParseException {
        ...
        Long between_days = (time2 - time1) / 1000L;
        return between_days;
    }

    public static void main(String[] args) {
        String _sys_time = "2016-9-5 18:07:10";
        String _now_time = date2Str((Date)null, "yyyy-MM-dd hh:mm:ss");
